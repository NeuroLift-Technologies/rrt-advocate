...
check_content "nltotoi.json"     "NeuroLift-Technologies/rrt-advocate" "Repository name in manifest"
...
check_content ".claude/hooks/session-start.sh" "ORG-DEV-OTOI-1.0.2" "OTOI version referenced in session-start hook"
