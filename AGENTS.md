# AGENTS.md — NeuroLift Technologies rrt-advocate Repository Agent Gateway

> **Internal use only.** This is the repository-specific governance gateway for coding agents operating in this repository. This copy is scoped to NeuroLift-Technologies/rrt-advocate, with project-specific operational context kept in this repository.
...
> **Repo-local note:** Governance docs in this repository are the working copy for NeuroLift-Technologies/rrt-advocate. Keep references local unless Joshua explicitly asks for an upstream sync.
...
- Repo-local governance context: [NeuroLift-Technologies/rrt-advocate](https://github.com/NeuroLift-Technologies/rrt-advocate)
...
All files below live in this repository (`NeuroLift-Technologies/rrt-advocate`):
